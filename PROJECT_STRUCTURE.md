...
- `sync_agentdojo_cases.py`: sync user/injection tasks from AgentDojo into `case_registry.json`.
- `build_case_pack_v1_50.py`: select and enrich strict 50-case pack from registry.

## End-to-end Flow
1. Generate/refresh registry: `scripts/sync_agentdojo_cases.py`
2. Build curated pack: `scripts/build_case_pack_v1_50.py`
